.. PsyNeuLink documentation (new format)
...
analysis -- from neural populations to cognitive functions to behavior. It is
best suited for:
...
- **Exploring interactions** between processes operating at different time
